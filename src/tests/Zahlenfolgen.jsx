                ...
                <div style={{ display: 'flex', gap: 10, alignItems: 'flex-start', marginBottom: 12 }}>
                  ...
                  <div style={{ flex: 1, minWidth: 0 }}>
                    <div style={{ color: T.muted, fontSize: 13, marginBottom: 12 }}>
                      Welche zwei Zahlen kommen als 8. und 9. Stelle?
                    </div>
        ...
        <Card>
            ...
            <div style={{ display: 'flex', gap: 8 }}>
              {[
                ...
                <button
                  ...
                  style={{
                    background: count === o.v ? `${T.blue}25` : T.surf2,
                    border: `1px solid ${count === o.v ? T.blue : T.border}`,
                    borderRadius: 8,
                    color: count === o.v ? T.blue : T.text,
                    cursor: 'pointer',
                    padding: '8px 18px',
                    fontSize: 14,
                    boxShadow: skF(0, i) ? `0 0 0 2px ${T.blue}` : 'none',
                  }}
                >
                  {o.l}
                </button>
          ...
          <button
            ...
            style={{
              ...
              fontSize: 16,
              fontWeight: 'bold',
              boxShadow: skS() ? `0 0 0 3px ${T.blue}88` : 'none',
            }}
          >
            Starten
          </button>
            ...
            <div style={{ marginTop: 16, background: T.surf2, borderRadius: 12, padding: '16px 20px' }}>
              <div style={{ fontSize: 14, marginBottom: 4 }}>
                {selected === q.correctIdx ? (
                  ...
                  <span>
                    Richtige Antwort:{' '}
                    <span style={{ color: T.green, fontWeight: 'bold' }}>{fmtChoice(q.choices[q.correctIdx])}</span>
                  </span>
                )}
              </div>
              {q.label && (
                <div style={{ color: T.muted, fontSize: 13, marginBottom: 14, fontStyle: 'italic' }}>{q.label}</div>
              )}
              <button
                onClick={nextQ}
                style={{
